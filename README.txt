Simple script using ruby and the Mechanize module to simulate accessing
the Novell/SUSE download servers used in SUSE Beta tests.
...
Written by Uwe Drechsel <uwedr@suse.com>under GPL V2.